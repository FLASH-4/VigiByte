          ...
          {!isLogin && (
            <div>
              ...
              <select
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-blue-500 transition-all appearance-none bg-no-repeat bg-right cursor-pointer pr-10 text-sm"
                style={{
